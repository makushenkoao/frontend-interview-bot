...
const learn = (ctx) => {
  const keyboard = Markup.inlineKeyboard([
    ...
    [Markup.button.callback("Продвинутая работа с функциями JS", "section-menu-mock")],
    [Markup.button.callback("Свойства объекта, их конфигурация JS", "section-menu-mock")],
    [Markup.button.callback("Прототипы, наследование JS", "section-menu-mock")],
    [Markup.button.callback("Классы JS", "section-menu-mock")],
    [Markup.button.callback("Обработка ошибок JS", "section-menu-mock")],
    [Markup.button.callback("Промисы, async/await JS", "section-menu-mock")],
    [Markup.button.callback("Генераторы, продвинутая итерация JS", "section-menu-mock")],
